...
export class createEntities1633923593283 implements MigrationInterface {
    name = 'createEntities1633923593283'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "pagamento" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "statusPagamento" integer NOT NULL, "title" character varying NOT NULL, "valor" numeric NOT NULL, "emailPagador" character varying NOT NULL, "pixDestinatario" character varying NOT NULL, "key" character varying, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "aluno_id" uuid NOT NULL, "professor_id" uuid NOT NULL, CONSTRAINT "PK_ac81e75b741a26f350c5fb1ff20" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "pagamento" ADD CONSTRAINT "FK_4720dff2dc58b5fc4e35f791627" FOREIGN KEY ("professor_id") REFERENCES "professor"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "pagamento" DROP CONSTRAINT "FK_4720dff2dc58b5fc4e35f791627"`);
