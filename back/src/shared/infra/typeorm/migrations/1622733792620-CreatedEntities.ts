...
export class CreatedEntities1622733792620 implements MigrationInterface {
  name = 'CreatedEntities1622733792620';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "pagamento" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "statusPagamento" integer NOT NULL, "title" character varying NOT NULL, "emailPagador" character varying NOT NULL, "valor" integer NOT NULL, "pixDestinatario" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "aluno_id" uuid NOT NULL, CONSTRAINT "PK_ac81e75b741a26f350c5fb1ff20" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "aluno_token" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "token" uuid NOT NULL DEFAULT uuid_generate_v4(), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "aluno_id" uuid NOT NULL, CONSTRAINT "PK_0abbe5976318ee4629b18f9dbd1" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "aluno" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "cpf" character varying NOT NULL, "email" character varying NOT NULL, "password" character varying NOT NULL, "avatar" character varying NOT NULL, "pix" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "bloqueio" boolean DEFAULT false, CONSTRAINT "PK_9611d4cf7a77574063439cf46b2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "pagamento" ADD CONSTRAINT "FK_40a6e7056b5da6824f02e354b3f" FOREIGN KEY ("aluno_id") REFERENCES "aluno"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "aluno_token" ADD CONSTRAINT "FK_04a119c3528335b35db40c0fc2c" FOREIGN KEY ("aluno_id") REFERENCES "aluno"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "disciplina" ADD CONSTRAINT "FK_c69a8c7446b0fd039dcacbf1bb4" FOREIGN KEY ("professor_id") REFERENCES "professor"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "professor_token" ADD CONSTRAINT "FK_61d62ccc776a1858bb7f590fe74" FOREIGN KEY ("professor_id") REFERENCES "professor"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "agendamento" ADD CONSTRAINT "FK_19427b7160b8fd87a80c1c48bbf" FOREIGN KEY ("disciplina_id") REFERENCES "disciplina"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "agendamento" DROP CONSTRAINT "FK_19427b7160b8fd87a80c1c48bbf"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "professor_token" DROP CONSTRAINT "FK_61d62ccc776a1858bb7f590fe74"`,
    );
    await queryRunner.query(
      `ALTER TABLE "disciplina" DROP CONSTRAINT "FK_c69a8c7446b0fd039dcacbf1bb4"`,
    );
    await queryRunner.query(
      `ALTER TABLE "disponibilidade" DROP CONSTRAINT "FK_96cf1b0e9f75ceddd30064dc38a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "aluno_token" DROP CONSTRAINT "FK_04a119c3528335b35db40c0fc2c"`,
    );
    await queryRunner.query(
      `ALTER TABLE "pagamento" DROP CONSTRAINT "FK_40a6e7056b5da6824f02e354b3f"`,
    );
