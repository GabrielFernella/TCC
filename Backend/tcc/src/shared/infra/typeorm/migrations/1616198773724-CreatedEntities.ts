...
export class CreatedEntities1616198773724 implements MigrationInterface {
    name = 'CreatedEntities1616198773724'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "professor_token" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "token" uuid NOT NULL DEFAULT uuid_generate_v4(), "professor_id" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_a265b0ff919e131ff539250462d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "pagamento" ADD CONSTRAINT "FK_bc355b3e472ed39956442f36319" FOREIGN KEY ("cartao_id") REFERENCES "cartao"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "cartao" ADD CONSTRAINT "FK_572ff0ceffea0184db2323b67fa" FOREIGN KEY ("aluno_id") REFERENCES "aluno"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "avaliacao" ADD CONSTRAINT "FK_2f7469858c9871f2d6e361d24dc" FOREIGN KEY ("professor_id") REFERENCES "professor"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "aula" ADD CONSTRAINT "FK_4ea35e6d4fe8cf54a4c1d04638b" FOREIGN KEY ("professor_id") REFERENCES "professor"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "agendamento" ADD CONSTRAINT "FK_10fdf4c99f68346529509fcdbee" FOREIGN KEY ("aula_id") REFERENCES "aula"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "agendamento" DROP CONSTRAINT "FK_10fdf4c99f68346529509fcdbee"`);
        ...
        await queryRunner.query(`ALTER TABLE "aula" DROP CONSTRAINT "FK_4ea35e6d4fe8cf54a4c1d04638b"`);
        await queryRunner.query(`ALTER TABLE "avaliacao" DROP CONSTRAINT "FK_2f7469858c9871f2d6e361d24dc"`);
        await queryRunner.query(`ALTER TABLE "disponibilidade" DROP CONSTRAINT "FK_96cf1b0e9f75ceddd30064dc38a"`);
        await queryRunner.query(`ALTER TABLE "cartao" DROP CONSTRAINT "FK_572ff0ceffea0184db2323b67fa"`);
        await queryRunner.query(`ALTER TABLE "pagamento" DROP CONSTRAINT "FK_bc355b3e472ed39956442f36319"`);
