...
export class CreatedEntities1620386037033 implements MigrationInterface {
    name = 'CreatedEntities1620386037033'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "agendamento" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "data" TIMESTAMP NOT NULL, "entrada" integer NOT NULL, "saida" integer NOT NULL, "link" character varying NOT NULL, "status" integer NOT NULL, "nota" character varying NOT NULL, "opiniao" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "aluno_id" uuid NOT NULL, "pagamento_id" uuid NOT NULL, "disciplina_id" uuid NOT NULL, "professor_id" uuid NOT NULL, CONSTRAINT "REL_afbfde78d726fc78a9c177c950" UNIQUE ("pagamento_id"), CONSTRAINT "PK_a102b15cfec9ce6d8ac6193345f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "dispo" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "date" jsonb array DEFAULT ARRAY[]::jsonb[], "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "professor_id" uuid NOT NULL, CONSTRAINT "PK_4fc23929181bce2b0fd27975795" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "dispo" ADD CONSTRAINT "FK_32386874688f653062cf0821e09" FOREIGN KEY ("professor_id") REFERENCES "professor"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "dispo" DROP CONSTRAINT "FK_32386874688f653062cf0821e09"`);
        ...
        await queryRunner.query(`DROP TABLE "dispo"`);
